...
El ATLAS.ti se originó en la Universidad Tecnológica de Berlín, en el marco del proyecto ATLAS, entre 1989 y 1992. El nombre es un acrónimo de _Archiv für Technik, Lebenswelt und Alltagssprache_, que en alemán quiere decir "Archivo para la Tecnología, el Mundo de la Vida y el Lenguaje Cotidiano". La extensión _.ti_ significa interpretación de textos. Se pueden encontrar mayores detalles sobre el origen del programa en el interesante relato de Heiner Legewie cite:[legewie2014]. En 1996 fue lanzada la primera versión comercial y en 2012 apareció la versión 7. El lanzamiento de la versión 8 se realizón en diciembre de 2016.

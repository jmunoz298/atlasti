...
.Esquema consulta (a)
image::image-143a.png[{alt="Esquema consulta (a)", align="center"]

[[img-esquema-consulta-b, Esquema consulta (b)]]
.Esquema consulta (b)
image::image-143b.png[{alt="Esquema consulta (b)", align="center"]
...
.Consulta múltiple
image::image-148a.png[{alt="Consulta múltiple", align="center"]

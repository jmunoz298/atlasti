...
image::images/image-007.png[Interfaz principal de ATLAS.ti, float="right",align="center"]
...
image::images/image-008.png[Interfaz principal con un documento activo, float="right",align="center"]
...
image::images/image-010.png[Visualización de dos Documentos Primarios, float="right",align="center"]

...
*11*. Haciendo clic en este icono, podemos visualizar simultáneamente más de un DP en la pantalla principal.

[[img-visualizacion-documentos, Visualización de dos Documentos Primarios]]
[.text-center]
.Visualización de dos Documentos Primarios
image::images/image-010.png[Visualización de dos Documentos Primarios, role="related thumb", align="center"]

...
image::images/image-007.png[{alt="Interfaz principal de Atlas.ti", float="right",  align="center"]
...
image::images/image-008.png[{alt="Interfaz principal con un documento activo", float="right", align="center"]

*6.  Información del documento activo*. Muestra el nombre del DP activo y, los iconos que aparecen a la derecha, permiten cerrar el documento y abrir (en el caso de que existan), los documentos relacionados con el DP activo (ver <<04-3-sincronizacion-audio-texto.adoc>> Sincronización audio-texto)
...
image::images/image-009.png[{alt="Navegadores de elementos en interfaz principal", float="right", align="center"]
...
image::images/image-010.png[{alt="Visualización de dos Documentos Primarios", float="right", align="center"]
...
.Barra de menús
image::images/image-011.png[{alt="Barra de menús", float="right", align="center"]
...
image::images/image-012.png[{alt="Administrador de códigos y lista desplegable de códigos", float="right", align="center"]
...
image::images/image-013.png[{alt="Administrador de Documentos Primarios", float="right", align="center"]
